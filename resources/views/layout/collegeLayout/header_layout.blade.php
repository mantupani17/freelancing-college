            ...
            <div id="menuzord" class="menuzord menuzord-responsive">
              ...
              <div class="menu-right">
                <div class="notification">
                  <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" data-display="static" aria-haspopup="true"
                    aria-expanded="false">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <a href="#">
                        <div class="media media-xs align-items-center">
                          <img class="rounded-circle mr-3" src="{{ asset('college_assets/assets/img/user/user-xs-1.jpg')}}" alt="Image">
                    ...
                    <li>
                      <a href="#">
                        <div class="media media-xs align-items-center">
                          <img class="rounded-circle mr-3" src="{{ asset('college_assets/assets/img/user/user-xs-2.jpg')}}" alt="Image">
                          <div class="media-body">
                    ...
                    <li>
                      <a href="#">
                        <div class="media media-xs align-items-center">
                          <img class="rounded-circle mr-3" src="{{ asset('college_assets/assets/img/user/user-xs-3.jpg')}}" alt="Image">
                          <div class="media-body">
                ...
                <div class="avatar">
                  <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" data-display="static"
                    aria-expanded="false">
                    <img class="avatar-img" src="{{ asset('college_assets/assets/img/user/user-3.jpg')}}" alt="Image">
                    <span class="avatar-name">Michael
                      <span class="small">List Admin</span>
                    </span>
                  </a>
                  <ul class="dropdown-menu">
                    <li>
                      <a class="d-flex flex-wrap align-items-center" href="profile-list-admin.html">
